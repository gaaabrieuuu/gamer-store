...
const ProdutoItem = (props: ProdutoItemProps) => {
  ...
  return (
    <Link
      ...
      className="flex flex-col bg-violet-dark relative border border-white/10 rounded-xl max-w-[350px]"
    >
      <div className="absolute felx justify-end top-2.5 right-2.5">
      ...
      <div className="flex-1 flex flex-col gap-3 p-5 border-t border-white/10">
        ...
        <div className="flex flex-col">
          <span className="text-sm text-gray-400 line line-through">
          ...
          {/* <span className="text-zinc-400 text-xs">
            até {CalcularParcelamento.qtdeParcelas} x de {' '} {Moeda.formatar(parcelamento.valorParcela)}
          </span> */}
        </div>
        <button
          className="
